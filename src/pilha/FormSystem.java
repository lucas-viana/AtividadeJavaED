...
public class FormSystem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        listDesempilha = new javax.swing.JTextArea();
        ...
        listDesempilha.setColumns(20);
        listDesempilha.setRows(5);
        jScrollPane3.setViewportView(listDesempilha);
    ...
    private void btnDesempilhaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDesempilhaActionPerformed
        ...
        listDesempilha.setText(desempilha.toString());
    ...
    private void btnEmpilha1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEmpilha1ActionPerformed
        ...
        newRecorde.setNome(txtNome.getText());
        String dataString = txtData.getText();
        
        DateTimeFormatter format = DateTimeFormatter.ofPattern("dd/MM/yyyy");
        LocalDate date = LocalDate.parse(dataString, format); 
        newRecorde.setDataRecorde(date);
        newRecorde.setTempo(Double.parseDouble(txtTempo.getText()));
        
        if(pilha.isEmpty() || pilha.peek().getTempo() > newRecorde.getTempo()){
            pilha.push(newRecorde);
            
            listPilha.setText(pilha.toString());
        } else {
            JOptionPane.showMessageDialog(null, "O novo record não é melhor que o ultimo", "", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private javax.swing.JTextArea listDesempilha;
